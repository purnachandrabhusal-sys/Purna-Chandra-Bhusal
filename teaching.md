...
layout: default
title: Teaching
lede: "Courses taught, teaching philosophy, and evidence of effectiveness."
permalink: /teaching/
description: "Teaching portfolio of Purna [Surname] — courses, philosophy, and student outcomes."
---

<!-- EDIT: everything in [brackets]. To add a course, copy one table row
     (a line starting and ending with "|") and change the details. -->
...
The principle of meaningfulness in teaching writing refers to inventing an invisible driving force that motivates and engages students in writing. Meaningfulness means finding (or better creating) a justifiable and motivating rationale behind every act of writing. As a facilitator, it is the instructor's responsibility to discuss with students why each act of writing matters and why it is important. I apply the principle of meaningfulness by discussing the underlying meaning of every activity associated with writing tasks that take place in or outside the classroom. I always invite students to think about compelling writing topics. In my experience, meaningful writing takes place when instructors design discussion sessions followed by writing activities that give students opportunities to write or collaborate on topics that truly interest them. I use the principle of meaningfulness to answer the question of why learn to write or why write.
...
A full teaching statement, sample syllabi, and student evaluations are available in my [CV (PDF)]({{ site.cv_file | relative_url }}) or on request.
